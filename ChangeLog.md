...
- BUGFIX: #5766 Added the `Last-used-window` hotkey (`Ctrl+Tab`) for macOS, for which Qt lacks proper implementation.
...
- CHANGE: #5701 SQLite3 version updated to 3.53.2.
